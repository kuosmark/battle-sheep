...
class TestGame(unittest.TestCase):
    ...
    def get_move_with_lowest_value(self, game) -> Tuple[float, Game | None]:
        possible_moves = get_possible_moves(game)
    ...
    def test_minimax_returns_the_best_initial_move_for_player_when_using_depth_1(self):
        ...
        self.assertEqual(move.get_pastures_occupied_by_player()[
                         0], best_move.get_pastures_occupied_by_player()[0])
    ...
    def test_minimax_returns_the_best_initial_move_for_computer_when_using_depth_1(self):
        ...
        self.assertEqual(value, best_value)
        self.assertEqual(move.get_pastures_occupied_by_computer()[
                         0], best_move.get_pastures_occupied_by_computer()[0])
